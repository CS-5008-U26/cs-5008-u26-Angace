...
/* Homework 9 - bubble sort
* 1. copy the templpate
* 2. implement bubble sort in the sortarray() function
* 3. run the test cases and verify that they pass
* 4. check time runned for 
* 4. Task 2 - add time run for sorted data, add time run for reverse sort data
*/
...
void sortarray (int a[], int n) {
    ...
    /* Bubble sort*/
    for (int i = 0; i < n - 1; i++){  // each pass moves the largest element to the end

        int swapped = 0; // keep track of whether any exchange was made
